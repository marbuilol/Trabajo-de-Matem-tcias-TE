...
h = 10^(10);
HTC = @(x,y) h;   % Coeficiente de transferencia de calor [W/m^2 K]
...
zlabel ("u");
digits=2;
title(sprintf("Distribución de temperaturas del perfil alar para K = %.*f W/mK y h= %.*f W/m^2K",digits,K,digits,h))
grid minor
