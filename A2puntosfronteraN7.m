...
frontr=boundary(xx,yy,0.9); %frontera exterior
...
%Guardado en un .txt de las fronteras para luego abrirlas en Octave y matriz de coordenadas X e Y
dlmwrite('frontd.txt', frontd, 'delimiter', ' ');
dlmwrite('frontr.txt', frontr, 'delimiter', ' ');
dlmwrite('M7.txt', M1, 'delimiter', ' ');
