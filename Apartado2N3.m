...
title('Mallado junto con sus fronteras N=3')
...
ylabel ("y");
zlabel ("u");
title('Distribución de temperaturas del perfil alar N=3')
grid minor
...
title('Zona de mínima temperatura N=3')
...
triplot(tri, x, y,'-b');
hold on
plot(x(in3),y(in3),'o','color','r','Linewidth',2)

title('Puntos coincidentes N=3')
